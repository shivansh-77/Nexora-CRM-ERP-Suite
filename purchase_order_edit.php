...
$vendors_query = "SELECT contact_person, company_name, mobile_no, address, city, gstno, state, country, pincode FROM contact_vendor";
      ...
      <form id="invoiceForm" method="POST" action="">
          ...
          <div class="form-section">
              <div class="column">
                  ...
                  <input type="text" id="vendor_company_name" name="vendor_company_name" value="<?php echo isset($purchase_order) ? $purchase_order['vendor_company_name'] : ''; ?>" readonly>
                  <label>Address:</label>
              ...
              <?php if (isset($purchase_order_items) && count($purchase_order_items) > 0): ?>
                  <?php foreach ($purchase_order_items as $item): ?>
                      <tr>
                          ...
                          <td><input type="number" name="rate[]" value="<?php echo $item['rate']; ?>" placeholder="Rate" class="small-input" oninput="calculateRow(this)"></td>
                          <td>
