  ...
  <body>
    <div class="leadforhead">
      ...
      <div class="lead-actions">
        ...
        <a href="expense_tracker_add.php">
      <button class="btn-primary" id="openModal" title="Add New Expense Tracker" data-mode="add">➕</button>
  </a>
      </div>
    </div>
              ...
              if (mysqli_num_rows($result) > 0) {
                  while ($row = mysqli_fetch_assoc($result)) {
                    echo "<tr ondblclick=\"window.location.href='expense_tracker_edit.php?id={$row['id']}'\" style='cursor: pointer;'>
                              ...
                              <td>
    <button class='btn-warning edit-btn' title='Update Expense Tracker'
        onclick=\"window.location.href='expense_tracker_edit.php?id={$row['id']}';\">✏️</button>
    <button class='btn-danger' title='Delete this Expense Tracker'
        onclick=\"if(confirm('Are you sure you want to delete this record?')) {
            window.location.href='expense_tracker_delete.php?id={$row['id']}';
        }\">🗑️</button>
</td>
                            </tr>";
                  }
