...
$item_query = "SELECT pi.*, p.invoice_no, p.shipper_location_code
               ...
               JOIN purchase_invoice p ON pi.invoice_id = p.id
               WHERE pi.id = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !isset($_POST['delete_lot'])) {
    ...
    echo '<script type="text/javascript">
            ...
            window.location.href = "purchase_lot_tracking_form_display.php?id=' . $invoice_id . '";
          </script>';
    exit();
        }
    }
...
<script>
    document.getElementById('crossBtn').addEventListener('click', function() {
        ...
        window.location.href = 'purchase_lot_tracking_form_display.php?id=' + encodeURIComponent(invoiceId);
    });
</script>
