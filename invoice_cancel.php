...
if (isset($_GET['id'])) {
    ...
    // Step 3: Fetch all items from invoice_items related to this invoice
    $items_query = "SELECT id AS invoice_itemid, product_name, product_id, quantity, rate, gst, amount, unit, value, igst, cgst, sgst, lot_trackingid, expiration_date
