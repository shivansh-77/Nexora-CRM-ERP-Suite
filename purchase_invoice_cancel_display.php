...
if (!empty($fy_codes)) {
    ...
    $query = "SELECT * FROM purchase_invoice_cancel_items WHERE 0"; // Returns no results
}
...
<body>
    <div class="leadforhead">
        <h2 class="leadfor">Purchase Cancel Invoices</h2>
        <div class="lead-actions">
            <div class="search-bar">
                <input type="text" id="searchInput" class="search-input" placeholder="Search...">
                <button class="btn-search" id="searchButton">🔍</button>
            </div>
            <a href="purchase_invoice_cancel_generate.php">
              ...
              if (mysqli_num_rows($result) > 0) {
                  while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      $disabled = ($pendingAmount == 0) ? 'disabled' : '';
                          ...
                          echo "<tr ondblclick=\"window.location.href='purchase_invoice_cancel_view.php?id={$row['id']}'\" style='cursor: pointer;'>
                              ...
                              <td>
                                  <button class='btn-secondary' title='Print this Invoice' onclick=\"window.location.href='purchase_invoice_cancel_view.php?id={$row['id']}'\">🖨️</button>
                                  <button class='btn-secondary' title='Cancel this Invoice' onclick=\"window.location.href='purchase_cancel_form_display.php?id={$row['id']}'\">❌</button>
                              </td>
                          </tr>";
                  }
              } else {
...
<div class="popup" id="popup">
  ...
  <div class="popup-footer">
    ...
    submitPaymentButton.addEventListener('click', function () {
        ...
        fetch('update_purchase_cancel_pending_amount.php', {
            method: 'POST',
            headers: {
