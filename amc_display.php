...
<body>
    <div class="leadforhead">
        <h2 class="leadfor">AMC Records</h2>
        <div class="lead-actions">
            ...
            <a href="amc_add.php">
                <button class="btn-primary" id="openModal" data-mode="add" title="Add New AMC Code">➕</button>
            </a>
        </div>
    </div>
    ...
    <button class='btn-danger'
            ...
            onclick=\"if(confirm('Are you sure you want to delete this record?')) { window.location.href='delete_amc.php?id={$row['id']}'; }\">🗑️</button>
</td>
                              </tr>";
                    }
                } else {
                    echo "<tr><td colspan='3'>No AMC records found</td></tr>";
                }
                ?>
            </tbody>
        </table>
