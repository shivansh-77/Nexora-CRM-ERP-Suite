...
if (isset($_GET['id'])) {
    ...
    $invoice_query = "SELECT * FROM purchase_invoice WHERE id = ?";
    ...
    if ($invoice) {
        // Fetch invoice items
        $items_query = "SELECT id, product_id, product_name, unit, value, quantity, rate, gst, igst, cgst, sgst, amount, receipt_date FROM purchase_invoice_items WHERE invoice_id = ?";
      ...
      // Fetch HSN/SAC code from item table
      ...
      $stmt_hsn->close();
        ...
        // Fetch lot details
        $lot_details = [];
        $lot_query = "SELECT product_id, product_name, quantity, location, lot_trackingid, expiration_date, invoice_id_main FROM item_ledger_history WHERE invoice_id_main = ? AND document_type = 'Purchase'";
        ...
        <div class="header">
            ...
            <div class="header-center">
                ...
                <div class="address-box">
                    <div><?php echo htmlspecialchars($invoice['shipper_address']); ?>, <?php echo htmlspecialchars($invoice['shipper_city']); ?>, <?php echo htmlspecialchars($invoice['shipper_state']); ?> - <?php echo htmlspecialchars($invoice['shipper_pincode']); ?></div>
                    <div>GST: <?php echo htmlspecialchars($company_details['gstno'] ?? ''); ?> | Phone: <?php echo htmlspecialchars($invoice['shipper_phone']); ?></div>
