...
$stmt = $conn->prepare("SELECT * FROM lead_for");
$stmt->execute();
              ...
              <td>
                <button class="btn-warning edit-btn"
                        ...
                        data-status="<?php echo $rows['status']; ?>"
                          >✏️</button>
                    <a href="delete_lead.php?id=<?php echo $rows['id']; ?>"
                        onclick="return confirm('Are you sure you want to delete this record?');">
                        <button class="btn-danger" onClick="showSuccessMessage('Lead deleted successfully')">🗑️</button>
</a>
              </td>
          </tr>
          <?php
...
?>
  ...
  <div class="modal" id="leadSourceModal">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="leadSourceForm" method="POST" action="lead_for_add.php"> <!-- Ensure correct action -->
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function openModal(mode, data = {}) {
      ...
      leadSourceForm.action = mode === "edit" ? "edit.php" : "lead_for_add.php"; // Set action based on mode
