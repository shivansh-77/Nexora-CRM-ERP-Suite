    ...
    <div class="user-table-wrapper">
      ...
      if (mysqli_num_rows($result) > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
              ...
              // Determine which page to redirect to based on document_no prefix and party_type
              // Determine which page to redirect to based on document_no prefix and party_type
              $document_no = $row['document_no'];
              $party_no = $row['party_no'];

              if (strpos($document_no, 'PVR') === 0) {
                  // For documents starting with PVR, go to advance_ledger_details.php
                  ...
                  // For documents starting with PVP and party_type Vendor
