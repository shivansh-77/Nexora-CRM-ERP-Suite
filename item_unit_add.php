...
<body>
    <div class="card">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="value"></textarea>
            </div>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $query = "INSERT INTO item_unit (unit, value) VALUES ('$unit', '$value')";
        if (mysqli_query($connection, $query)) {
            echo "<script>alert('Unit Measurement record added successfully!'); window.location.href='item_unit_display.php';</script>";
        } else {
