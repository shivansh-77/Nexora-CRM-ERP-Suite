                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                      echo "<tr>
                              ...
                              <td>
                                  ...
                                  <button class='btn-secondary' title='Add Lot Details for this Invoice items' onclick=\"window.location.href='purchase_cancel_form_display.php?id={$row['id']}'\">📋</button>
