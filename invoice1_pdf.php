...
$company_query = "SELECT address, city, pincode, email_id, gstno, contact_no, company_logo, company_name FROM company_card WHERE id = 1";
...
<body>
    <div class="invoice-container">
        <div class="header">
            <img src="<?php echo $company_details['company_logo'] ?? 'uploads/default_logo.png'; ?>" alt="Logo" class="logo" />
            <div class="header-center">
                <div class="company-name"><?php echo htmlspecialchars($company_details['company_name'] ?? 'Company Name'); ?></div>
                <?php if ($invoice) { ?>
        ...
        <?php if (!empty($lot_details) || !empty($amc_details)): ?>
        ...
        <div class="footer">
            ...
            <div style="text-align: center; margin-bottom: 5px;">
                ...
                Website: https://splendidinfotech.com/
            </div>
