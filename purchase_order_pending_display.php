...
// Step 2: Fetch Purchase Order Records with status = 'Pending'
if (!empty($fy_codes)) {
...
<head>
    ...
    html, body {
        ...
        .user-table th, .user-table td {
            padding: 8px; /* Increased padding for wider columns */
            border: 1px solid #ddd;
            overflow: hidden;
...
<body>
    <div class="leadforhead">
        <h2 class="leadfor">Pending Purchase Orders</h2>
        ...
        <table class="user-table" id="purchaseOrderTable">
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) > 0) {
                   ...
                   echo "<tr><td colspan='10' style='text-align: center;'>No pending purchase orders found</td></tr>";
                }
                ?>
            </tbody>
        </table>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function() {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, 'Pending Purchase Orders');

        // Export the workbook to an Excel file
        XLSX.writeFile(workbook, 'pending_purchase_orders.xlsx');
    });
