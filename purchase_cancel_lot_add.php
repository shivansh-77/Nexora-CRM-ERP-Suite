...
$item_query = "SELECT pi.*, p.invoice_no, p.shipper_location_code
               ...
               JOIN purchase_invoice_cancel p ON pi.invoice_id = p.id
               WHERE pi.id = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !isset($_POST['delete_lot'])) {
    ...
    echo '<script type="text/javascript">
            ...
            window.location.href = "purchase_cancel_form_display.php?id=' . $invoice_id . '";
          </script>';
    exit();
        }
    }
...
<body>
  <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
    <h2 style="margin: 0;">Add Lot Details - Purchase Invoices Cancel</h2>
...
<script>
    document.getElementById('crossBtn').addEventListener('click', function() {
        ...
        window.location.href = 'purchase_cancel_form_display.php?id=' + encodeURIComponent(invoiceId);
    });
</script>
