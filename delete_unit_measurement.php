...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $check_query = "SELECT id FROM unit_of_measurement WHERE id = ?";
    ...
    if ($check_stmt->num_rows > 0) {
        ...
        $delete_query = "DELETE FROM unit_of_measurement WHERE id = ?";
        ...
        if ($delete_stmt->execute()) {
            ...
            echo "<script>alert('Error deleting record: " . addslashes($delete_stmt->error) . "'); window.location.href='unit_measurement_display.php';</script>";
        }
