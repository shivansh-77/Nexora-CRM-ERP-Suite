...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM lead_sourc WHERE id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE lead_sourc SET name = '$name', status = '$status' WHERE id = $id";
    if (mysqli_query($connection, $query)) {
        // Redirect to contact.php with the leadFor parameter (name from the updated row)
