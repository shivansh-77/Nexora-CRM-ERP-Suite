...
<body>
    <div class="card">
        ...
        <div class="card-header">Edit Item Category</div>
        <?php
        // Database connection
        ...
        if (isset($_GET['id']) && is_numeric($_GET['id'])) {
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo "<script>alert('Record not found!'); window.location.href='item_category_display.php';</script>";
            }
        } else {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $updateQuery = "UPDATE item_category SET code = '$code', description = '$description' WHERE id = $id";
            if (mysqli_query($connection, $updateQuery)) {
                echo "<script>alert('Item Category  updated successfully!'); window.location.href='item_category_display.php';</script>";
            } else {
                echo "<script>alert('Error updating Item Category.');</script>";
            }
        }
        ?>
