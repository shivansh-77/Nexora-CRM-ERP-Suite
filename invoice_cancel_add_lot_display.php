...
if (!empty($fy_codes)) {
    ...
    $query = "SELECT * FROM invoice_cancel_items WHERE 0"; // Returns no results
}
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr ondblclick=\"window.location.href='invoice_cancel_form_display.php?id={$row['id']}'\" style='cursor: pointer;'>
                <td>{$row['id']}</td>
                ...
                <td>
                    <button class='btn-secondary' title='Edit this Invoice' onclick=\"window.location.href='invoice_sale_edit.php?id={$row['id']}'\">✏️</button>
                    <button class='btn-secondary' title='Add Lot Details for this Invoice items' onclick=\"window.location.href='invoice_cancel_form_display.php?id={$row['id']}'\">📋</button>
                    <button class='btn-secondary' title='Close this Invoice' onclick=\"window.location.href='invoice_close.php?id={$row['id']}'\">⛔</button>
                </td>
            </tr>";
    }
} else {
