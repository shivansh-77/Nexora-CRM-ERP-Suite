    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($stmt_update->execute()) {
            ...
            if ($stmt_history_insert->execute()) {
                echo "<script>alert('Record Updated and History Added Successfully'); window.location.href='missed_followup.php';</script>";
            } else {
...
<body>
    <div class="container">
        <!-- Cross Button -->
      <a style="text-decoration:None;"href="missed_followup.php" class="close-btn">&times;</a>
        ...
        <form method="POST" action="">
            ...
            <div class="button-container">
                ...
                <a href="missed_followup.php" class="btn" role="button">Cancel</a>
            </div>
        </form>
    </div>
</body>
