...
if (isset($_GET['invoice_id'])) {
    ...
    $check_status_query = "SELECT status, invoice_no FROM invoices_cancel WHERE id = ?";
    ...
    try {
        ...
        $last_invoice_query = "
            ...
            FROM invoices_cancel WHERE invoice_no LIKE ?
        ";
        $pattern = "SR/$currentYear/%";
